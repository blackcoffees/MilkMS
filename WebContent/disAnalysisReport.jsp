                        	...
                        	<template v-for="(menu, i) in menu_list">
                        		<li class="nav-item" :class="{start: i == 1, active: menu.href=='javascript:void(0)', open: menu.href=='javascript:void(0)'}">
	                                ...
	                                <ul v-if="menu.children" class="sub-menu" style="display: block;">
										<li v-for="child in menu.children"  :class="{'nav-sub-menu-hover': child.href == 'goodsAnalysisReport.jsp'}">
											<a :href="child.href">
                    ...
                    <div class="page-content">
                        ...
                        <div class="tabbable-custom tabbable-full-width">
                        	<ul class="nav nav-tabs" style="border-bottom:1px solid #cecece;">
								<li >
									<a href="goodsAnalysisReport.jsp" data-toggle="tab">商品销售报表</a>
								</li>
								<li class="active">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase">明星商家</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                            ...
                            <div class="col-md-6">
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            <i class="icon-bubbles font-dark hide"></i>
                                            <span class="caption-subject font-dark bold uppercase">危机商家</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        <div class="tab-content">
