...
<script src="static/js/light.js" type="text/javascript"></script>
<script src="static/js/patterns.js" type="text/javascript"></script>
<script src="static/js/chalk.js" type="text/javascript"></script>
<script src="static/js/worldLow.js" type="text/javascript"></script>
<script src="static/js/amstock.js" type="text/javascript"></script>
-->
...
<!-- 地图 -->
<!-- <script src="static/js/ammap.js" type="text/javascript"></script>-->

<!-- 水平时间轴 -->
<!-- <script src="static/js/horizontal-timeline.js" type="text/javascript"></script>-->

<!-- 图表 -->
<!-- 
<script src="static/js/jquery.flot.min.js" type="text/javascript"></script>
<script src="static/js/jquery.flot.resize.min.js" type="text/javascript"></script>
<script src="static/js/jquery.flot.categories.min.js" type="text/javascript"></script>
-->

<!-- 统计新的访问、跳出率、服务器负载、使用的RAM等 -->
...
<script src="static/js/quick-nav.min.js" type="text/javascript"></script>
-->
...
<link href="static/css/darkblue.min.css" rel="stylesheet" type="text/css" id="style_color" />
...
<!-- 自定义翻页插件 -->
<link href="static/js/paginate_tool.js" rel="stylesheet" type="text/css"/>
