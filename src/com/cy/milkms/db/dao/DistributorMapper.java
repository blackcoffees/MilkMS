...
public interface DistributorMapper {
	...
	public int updateDistributor(@Param("address")String address, @Param("people")String people, @Param("phone")String phone, @Param("updated")Timestamp updated, @Param("ID")String ID);
}
